...
class TuneRepositoryTest {
    ...
    public void testCRUD() {
        ...
        TuneEntity save1 = tuneRepository.save(new TuneEntity(null, "b", "c", "d", null));
        TuneEntity save2 = tuneRepository.save(new TuneEntity(null, "e", "f", "g", "null"));
        TuneEntity save3 = tuneRepository.save(new TuneEntity(null, "h", "i", "j", "null"));
        ...
        tuneRepository.save(new TuneEntity(save2.getId(), "E", "F", "G", null));
